...
from clothes.models import Men_Shirt,Men_Jacket,Men_Pants,Men_Joggers,Glasses,Earring,Necklace,Women_Shirt,Women_Jacket,Women_Pants,Women_Joggers,Cart
...
class CartSerializer(serializers.ModelSerializer):
    class Meta:
        model = Cart
        fields = ['men_shirt','men_jacket','men_pants','men_joggers',
                  'glasses','earring','necklace','women_shirt','women_jacket',
